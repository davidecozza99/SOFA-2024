...
figure_directory <- here("output", "decomposition", "AUS_with_trade", paste0(gsub("-", "", Sys.Date())))
...
# write.xlsx(bra, file = here("data", "Decomposition", paste0(gsub("-", "",Sys.Date()), "_", "bra.xlsx")))
...
# folder to store the plots
figure_directory <- here("output", "decomposition", "BRA_with_trade", paste0(gsub("-", "", Sys.Date())))
dir.create(figure_directory, recursive = TRUE, showWarnings = FALSE)
...
# folder to store the plots
figure_directory <- here("output", "decomposition", "COL_with_trade", paste0(gsub("-", "", Sys.Date())))
dir.create(figure_directory, recursive = TRUE, showWarnings = FALSE)
...
# folder to store the plots
figure_directory <- here("output", "decomposition", "ETH_with_trade", paste0(gsub("-", "", Sys.Date())))
dir.create(figure_directory, recursive = TRUE, showWarnings = FALSE)
...
# folder to store the plots
figure_directory <- here("output", "decomposition", "GBR_with_trade", paste0(gsub("-", "", Sys.Date())))
dir.create(figure_directory, recursive = TRUE, showWarnings = FALSE)
...
figure_directory <- here("output", "decomposition", "all_country_with_trade", gsub("-", "", Sys.Date()))
dir.create(figure_directory, recursive = TRUE, showWarnings = FALSE)
