...
db_full <- readxl::read_excel(here("data", "scenathon_2023", "20231113_ExtractedPdtyLivestock.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3))
...
db_full2 <- readxl::read_excel(here("data", "scenathon_2023", "20231113_ExtractedRumDensity.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3))
...
db_full_crop <- readxl::read_excel(here("data", "scenathon_2023", "20231113_ExtractedPdtyCrop.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3))
...
db_full_expansion <- readxl::read_excel(here("data", "scenathon_2023", "20231113_ExtractedExpansion.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3)) %>% 
...
db_full_affor <- readxl::read_excel(here("data", "scenathon_2023", "20231114_ExtractedAfforestation.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3))%>% 
  mutate(ALPHA3 = ifelse(nchar(ALPHA3) == 4, stringr::str_sub(ALPHA3, 2, 4), ALPHA3))
...
db_full_waste <- readxl::read_excel(here("data", "scenathon_2023", "20240115_ExtractedFoodWaste.xlsx")) %>% 
  mutate(ALPHA3 = ifelse(ALPHA3 == "RME", "NMC", ALPHA3))%>% 
  mutate(ALPHA3 = ifelse(nchar(ALPHA3) == 4, stringr::str_sub(ALPHA3, 2, 4), ALPHA3)) %>% 
